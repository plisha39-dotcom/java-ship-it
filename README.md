...
## История версий
- `v1.0.0` — базовая версия проекта с типами посылок и основной логикой
- `v1.1.0` — добавлены тесты для бизнес-логики
- `v1.2.0` — улучшена логика упаковки для хрупких посылок

## Планы по развитию
- улучшить валидацию данных
- добавить более удобный вывод в консоль
